IMPORT $,STD;
Crimes:=$.Lab5_File_crime_optimized;
...
Formatted_File := PROJECT(Crimes.File,Reformatter(LEFT,COUNTER));

// OUTPUT of the clean dataset
OUTPUT(Formatted_File,,'~chicago::bssa::out::Formatted_file',overwrite);